...
router.get("/ordenDetalle", authenticateToken, authorizeRole([1,2,3]), obtenerOrdenesConDetalle);
router.get("/ordenDetalle/:idOrden", authenticateToken, authorizeRole([1,2]), obtenerOrdenConDetalle);
router.post("/ordenDetalle/", authenticateToken, authorizeRole([1,2,3]), crearOrdenDetalle);
